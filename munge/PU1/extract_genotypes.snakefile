...
rule make_all:
    input:
        # expand("/gpfs/hpchome/a72094/rocket/projects/chromatin-QTLs/Blood_ATAC/results/PU1/genotypes/Waszak_47_samples.chr{chromosome}.vcf.gz", chromosome = CHROMS)
        expand("/home/jupyter/DATA/Blood_ATAC/landerlab-vcf/1000_genomes_vcfs/Waszak_47_samples.chr{chromosome}.vcf.gz", chromosome = CHROMS)
    output:
        "munge/{study}/out.txt"
    threads: 1
    resources:
...
rule extract_genotypes:
    input:
        ...
        vcf = "/home/jupyter/DATA/Blood_ATAC/landerlab-vcf/1000_genomes_vcfs/ALL.chr{chromosome}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz",
        samples = "/home/jupyter/DATA/Blood_ATAC/data/Waszak_2015/Waszak_2015_genotype_list.txt"
    output:
        vcf = "/home/jupyter/DATA/Blood_ATAC/landerlab-vcf/1000_genomes_vcfs/Waszak_47_samples.chr{chromosome}.vcf.gz"
    threads: 1
    resources:
        mem = 3000
    shell:
